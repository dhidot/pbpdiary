                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            while ($row = mysqli_fetch_array($ret)) { ?>
                                <tr>
                                    ...
                                    <td><a href="view-note.php?nhid=<?php echo $row['id'] ?>&del=delete"
                        ...
                        <div align="center">
                            <button class="btn btn-primary" type="button" data-bs-toggle="modal"
                                    data-bs-target="#exampleModal">Add More Note
                            </button>
                        </div>
                    </div>
                </div>
        ...
        <form method="post" name="takeaction">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p>
                            <textarea class="form-control" required name="remark" placeholder="Enter Note Details"
                                      rows="5"></textarea></p>
                </div>
