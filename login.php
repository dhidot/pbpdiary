                    ...
                    <form method="post">
                        <div class="form-floating mb-3">
                            <input class="form-control" id="inputEmail" type="text" name="logindetail"
                                   placeholder="Registered Email id"/ <?php if (isset($email)) echo $email; ?>
                            >
                        ...
                        <div>
                            <p style="font-style: italic; color: red; font-weight: bold"><?php if (isset($error_login)) echo $error_login; ?></p>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                            <a class="small" href="password-recovery.php">Lupa kata sandi?</a>
                            <button class="btn btn-primary" type="submit" name="login">Login</button>
                        </div>
                    </form>
                </div>
                <div class="card-footer text-center py-3">
                    <div class="small"><a href="registration.php">Belum memiliki akun? Daftar!</a></div>
                    <hr/>
                    <div class="small"><a href="index.php" style="text-decoration: none">Kembali ke Home Page</a></div>
                </div>
            </div>
        </div>
